...
class Html2pdf {
    ...
    function create($mode = 'download') {
        ...
        require_once("dompdf-new/autoload.inc.php");
        // use dompdf-new\dompdf
        ...
        if ($mode == 'save') {
            ...
            $this->CI->load->helper('file');
            write_file($this->path . $this->filename, $dompdf->output());
            if ($dompdf->stream($this->filename, array("Attachment" => true))) {
                return TRUE;
            } else {
