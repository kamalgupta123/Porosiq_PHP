                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2">
                    <div class="panel panel-info">
                        ...
                        <form id="add_projects_form"
                              action="<?php echo site_url('insert_projects'); ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div style="margin-top:20px;" class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6 col-md-8">
                                                <div class="input-group">
                                                    <input class="form-control validate[required]" type="text" id="project_name" name="project_name" placeholder="Project Name" value="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6 col-md-8">
                                                <div class="input-group">
                                                    <input class="form-control validate[required]" type="text" id="client_name" name="client_name" placeholder="Client Name" value="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6 col-md-8">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="approx_total_time" name="approx_total_time" placeholder="Approx. Total Time(hrs)" value="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6 col-md-8">
                                                <div class="input-group">
                                                    <input class="form-control" type="text" id="monthly_payment" name="monthly_payment" placeholder="Monthly Payment" value="">
                                                </div>
                                            </div>
                                        </div>
