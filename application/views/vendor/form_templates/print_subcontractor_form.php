...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .mar{ margin-bottom: 10px; line-height: 40px;}
            .image {
                text-align: center;
        ...
        <div class="container">
            ...
            <div class="subcon">
                ...
                <strong.Restrictive Covenant
                    ...
                    <table width="95%" style="border:none; text-align:left; overflow:hidden;border-collapse: collapse; border-spacing: 0;padding: 20px 0 200px;">
                        <tr class="mar">
                        ...
                        <tr class="mar">
                            ...
                            <td style="border: none;width: 20%;">&nbsp;</td>
                            <td style="border: none;width: 20%;">&nbsp;</td>
                            <td style="border-color: currentcolor currentcolor #000;border-image: none;border-style: none none solid;border-width: medium medium 1px;width: 20%;font-family: 'Dancing Script', cursive;">
                                <?= $emp_signature ?>
                            </td>
                        </tr>
                        <tr class="mar">
                            <td style="border: none;width: 20%;">Witnessth:</td>
                            <td style="border: none;width: 20%;">&nbsp;</td>
                            <td style="border: none;width: 20%;">&nbsp;</td>
                            <td style="border-color: currentcolor currentcolor #000;border-image: none;border-style: none none solid;border-width: medium medium 1px;width: 20%;font-family: 'Dancing Script', cursive;">
                                <?= $emp_witnessth ?>
