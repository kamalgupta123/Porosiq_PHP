    ...
    <body style="font-size: 14px;">
        ...
        <div class="container">
            ...
            <div class="subcon">
                <p style="line-height: 25px;">This Non-disclosure Agreement (this "Agreement") is made effective as
                    of,<span class="sub-css"><?php echo $nda_day ?></span>day of <span
                        class="sub-css"><?php echo $nda_month ?></span>,20<span class="sub-css" style="text-align: left !important; width: 5%;"><?php echo $nda_year ?></span>
                    (the
            ...
            <div class="subcon">
                ...
                <table width="100%" style="border:none; text-align:left; overflow:hidden;border-collapse: collapse; border-spacing: 0;padding: 20px 0 200px;">
                    <tr class="mar">
                        <td style="border: none;width: 20%;">OWNER :</td>
                        <td style="border: none;width: 20%;">&nbsp;</td>
                        <td style="border: none;width: 20%;">&nbsp;</td>
                        <td style="border-color: currentcolor currentcolor #000;border-image: none;border-style: none none solid;border-width: medium medium 1px;width: 20%; font-weight: bold;">RECIPIENT :</td>
                    </tr>
                    <tr class="mar">
                    ...
                    <tr class="mar">
                        <td style="border: none;width: 20%;">By :</td>
                        <td style="width:20%;border-color: currentcolor currentcolor #000;border-image: none;border-style: none none solid;border-width: medium medium 1px; font-family: 'Dancing Script', cursive;"><?php
            ...
            <div style="text-align:left;font-size: 12px;"> <?php if (isset($vendor_ip) && $vendor_ip != '') {
                                echo "IP" . " - " . $vendor_ip;
                            } ?></div>
