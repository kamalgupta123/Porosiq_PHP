...
<html lang="en">
	<head>
		...
		<link
			...
			rel="stylesheet"
		/>
		<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/otp.css" />
		<link
			rel="stylesheet"
			...
			<div class="container">
				...
				<div class="hero">
					<section class="content">
						...
						<div class="loginBox">
							<h5 class="loginBox__heading">Verify OTP</h5>
							<p class="loginBox__forgotPassword">
								Enter the OTP below which you have got through email address
								assosiated with your account.
							</p>
                            ...
                            <?php } ?>
							<form action="<?php echo site_url('vendor_valid_otp'); ?>" method="post" enctype="multipart/form-data" class="loginBox__formContainer">
								...
								<div class="loginBox__otpContainer">
									<p class="mb-1">Email OTP</p>
									<input
										class="loginBox__userid form-control"
										type="text"
										placeholder="OTP"
								...
								<div class="loginBox__login">
									<a class="loginBox__back" href="<?php echo site_url('vendor-forgot-password'); ?>">Go Back</a>
									<input
										type="submit"
										value="Submit"
