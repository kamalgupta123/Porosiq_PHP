                                    ...
                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                                        <tr>
                                            <td align="left" valign="top" style="font-family: Palatino Linotype, Book Antiqua, Palatino, serif; font-size: 16px; font-weight: 400; line-height: 24px;">
                                                <p style="font-weight: 800;"><?php echo $vendor_name . " has assigned a new consultant for the following project. Project details and Consultant details are as follows:" ; ?></p>
                                                <p style="font-weight: 300;width: 45%;float: left;font-size: 12px;">
                                                    ...
                                                    <label style="font-weight: bold;">Project Start Date : </label><?php echo date("d-m-Y", strtotime($get_project_details['0']['start_date'])); ?><br/>
                                                </p>
                                                <p style="font-weight: 300;width: 55%;float: left;font-size: 12px;">
                                                    ...
                                                    <label style="font-weight: bold;">Consultant Code : </label><?php echo strtoupper($get_employee_details['0']['employee_code']); ?><br/>
                                                    <label style="font-weight: bold;">Consultant Name : </label><?php echo $get_employee_details[0]['name_prefix']. " " .ucwords($get_employee_details[0]['first_name']." ".$get_employee_details[0]['last_name']); ?><br/>
                                                    <label style="font-weight: bold;">Consultant Designation : </label><?php echo $get_employee_details[0]['employee_designation']; ?><br/>
                                                    <label style="font-weight: bold;">Consultant Category : </label><?php echo ($get_employee_details[0]['employee_category'] == '1')?"W2":"Subcontractor"; ?><br/>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
