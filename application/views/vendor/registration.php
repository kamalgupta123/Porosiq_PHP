...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="<?php echo site_url('vendor_valid_registration'); ?>" method="post" enctype="multipart/form-data"
            ...
            <div class="form-group has-feedback">
                <input type="text" class="form-control validate[required]" name="company_id" placeholder="Company ID">
                <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
            ...
            <div class="form-group has-feedback">
                <input type="password" name="conf_password" class="form-control validate[required,equals[password]]" placeholder="Confirm Password">
                <span class="glyphicon glyphicon-lock form-control-feedback"></span>
            </div>
            <div class="row">
...
<script>
    $(document).ready(function () {
        ...
        $("#registration_form").validationEngine({promptPosition: 'inline'});
    });
