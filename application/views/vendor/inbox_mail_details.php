                    ...
                    <div class="col-lg-12 col-sm-12 col-md-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">
                                    <div class="">
                                        <a href="<?php echo site_url('vendor_inbox'); ?>"><span
...
// echo $recipient_type;
                                                        if ($recipient_type == "vendor") {
                                                            ?>
                                                            <a href="<?php echo site_url() . "vendor_inbox_mail_reply" . "/" . base64_encode($id) . "/" . base64_encode($sender_id); ?>"><span
                        ...
                        if (!empty($check_reply_mails)) {
                            foreach ($check_reply_mails as $reply_val) {
                                if ($reply_val['sender_id'] == $vendor_id || $reply_val['recipient_id'] == $vendor_id) {
                                    ...
                                    $recipient_type = $reply_val['recipient_type'];
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <div class="">
                                                                    ...
                                                                    if ($recipient_type == "vendor") {
                                                                        ?>
                                                                        <a href="<?php echo site_url() . "vendor_inbox_mail_reply" . "/" . base64_encode($id) . "/" . base64_encode($from_id); ?>"><span
                                                                                class="glyphicon glyphicon-arrow-left"></span>&nbsp;
                                                                            Reply</a>
                                                                        <?php
                                                                    }
