...
//                                        print_r($check_reply_mails);
                    ...
                    if (!empty($check_reply_mails)) {
                        foreach ($check_reply_mails as $reply_val) {
                            if ($reply_val['recipient_id'] == $vendor_id) {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                ...
                                                <input type="hidden" name="recipient_type" id="recipient_type"
                                                       value="<?php echo $recipient_type; ?>">
                                                <input type="hidden" name="sender_id" id="sender_id"
                                                       value="<?php echo $vendor_id; ?>">
                                                <input type="hidden" name="sender_type" id="sender_type" value="vendor">
...
<script>
    ...
    $(function () {
        ...
        $("#submit").on("click", function () {
            ...
            if (message != '') {
                $.post("<?php echo site_url('vendor_send_reply'); ?>", {
