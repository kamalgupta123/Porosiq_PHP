    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="">Consultant Onboarding</a></li>
            </ol>
        </section>
                                        ...
                                        foreach ($get_documents_details as $aval) {
                                            ...
                                            if (in_array($employee_type, $required_for_arr)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>upload_vendor_consultant_documents/<?php echo base64_encode($aval['id']) . '/' . base64_encode($employee_id); ?>" style="color: #09274B;"><i class="fa fa-upload" aria-hidden="true"></i> Upload Document</a>    
                                                    </td>
                                                    <td align="center">
                                                        <?php
                                                        if (!empty($get_uploaded_document)) {
                                                            if ($get_uploaded_document[0]['file'] != '') {
                                                                ...
                                                                ?>
                                                                <a href="<?php echo base_url(); ?>vendor-show-files/<?php echo base64_encode($get_uploaded_document[0]['form_no']) . "/" . base64_encode($get_uploaded_document[0]['consultant_id']); ?>" class="fancybox" style="color: #09274B;"><i class="fa fa-eye" aria-hidden="true"></i> View File</a>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
