...
//                }
                ...
                ?>
                <li>
                    <a href="<?php echo site_url('vendor_inbox_mail_details') . "/" . base64_encode($id); ?>">
                        <div class="pull-left">
                            <?php
                            if ($file != '') {
                                ?>
                                <img
                                    src="<?php echo site_url() . $file_path . $file; ?>"
                        ...
                        <h4>
                            <span style="font-size: 12px;">
                                ...
                                if (strlen($subject) > 20) {
                                    echo substr($subject, 0, 15) . "..";
                                } else {
                                    echo $subject;
                                }
                                ?>
                            </span>
                            <small><i class="fa fa-clock-o"></i> <?php echo $interval->format('%h') . " hours " . $interval->format('%i') . " minutes"; ?></small>
                        </h4>
                        <span style="font-size: 12px;">
                           <?php
...
<li class="footer"><a href="<?php echo site_url('vendor_inbox'); ?>">See All Messages</a></li>