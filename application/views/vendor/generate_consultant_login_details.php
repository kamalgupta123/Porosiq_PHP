    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="">Generate Login Details</a></li>
            </ol>
        </section>
...
//                                    print_r($get_employee_details);
                                ...
                                <table class="table" style="font-size: 11px;">
                                    ...
                                    <tr>
                                        <td><label>Consultant Full Name</label></td>
                                        <td>
                                            <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            echo date("d-m-Y", strtotime($get_employee_details[0]['date_of_joining']));
                                            ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if (!empty($get_employee_details[0]['resume_file']) && $get_employee_details[0]['resume_file'] != '') {
                                                ?>
                                                <span><a href="<?php echo base_url(); ?>uploads/<?php echo $get_employee_details[0]['resume_file']; ?>" target="_blank">Download Uploaded File</a></span>
                                                <?php
                                            }
                                            ?>
                                        </td>
                            ...
                            <div class="col-lg-6 col-sm-6 col-md-6" style="border-top: 1px #f4f4f4 solid;">
                                <form id="generate_form"
                                      action="<?php echo site_url('generate_login_details'); ?>"
                                      method="post" enctype="multipart/form-data">
                                    <div class="panel-body" style="margin-top: 200px;">

                                        <table class="table" style="font-size: 11px;">
                                            <tr>
                                                <td><label>Consultant Email ID <span style="color: red;">*</span></label></td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control validate[required]" type="text" id="consultant_password" name="consultant_password" rel="gp" data-size="8" data-character-set="a-z,A-Z,0-9,#" style="width: 98%;">
