			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					function client_dataRecieved(result) {
						...
						if (userID != undefined) {
							window.location.href = '<?php echo base_url(); ?>vendor_qr_code/'+userID; //site_url use here
						}
					}
				...
				<div class="content">
					...
					<div class="content__inputBox">
						<div class="loginBox">
                            ...
                            <?php } ?>
							<form action="<?php echo site_url('vendor_valid_login'); ?>" method="post" enctype="multipart/form-data" class="loginBox__formContainer">
								<div class="loginBox__loginAs form-group">
									...
									>
										<?php echo get_login_user_types('vendor', true); ?>
									</select>
								</div>
								...
								<div class="loginBox__login">
									...
									<a class="loginBox__forgot" href="<?php echo base_url('vendor-forgot-password'); ?>">Forgot Password?</a>
								</div>
								<input
									type="submit"
									value="Sign In"
							...
							<!-- <form action="<?php echo site_url('vendor_okta_login'); ?>" method="post" enctype="multipart/form-data" class="loginBox__formContainer">
								<div class="loginBox__loginAs form-group">
									<label for="user">Login as</label>
									<select
										style="padding-left: 8px;"
