                    ...
                    <div class="col-lg-12 col-sm-12 col-md-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">
                                    <div class="">
                                        <a href="<?php echo site_url('vendor_sent_items'); ?>"><span
                            ...
                            <div class="box-body">
                                <div class="col-sm-12 col-md-12">
                                    <?php
                                    if (!empty($get_sent_mail_details)) {

                                        $recipient_name = "";
                                        $recipient_email = "";
                                        $recipient_email_shw = "";

                                        $reply_id = $get_sent_mail_details[0]['reply_id'];
                                        $mail_id = $get_sent_mail_details[0]['id'];
                                        $recipient_id = $get_sent_mail_details[0]['recipient_id'];
                                        $recipient_type = $get_sent_mail_details[0]['recipient_type'];


                                        if ($reply_id == 0) {

                                            $subject = stripslashes($get_sent_mail_details[0]['subject']);
                                            $message = stripslashes($get_sent_mail_details[0]['message']);
                                            $datetime = $get_sent_mail_details[0]['entry_date'];
                                            $id = $mail_id;
                                            ...
                                            if ($get_sent_mail_details[0]['sender_type'] == 'superadmin') {
                                                $get_sender_details = $this->communication_model->getSuperAdminDetails($get_sent_mail_details[0]['sender_id']);
                                            ...
                                            if ($get_sent_mail_details[0]['sender_type'] == 'admin') {
                                                $get_sender_details = $this->communication_model->getAdminDetails($get_sent_mail_details[0]['sender_id']);
                                                if (!empty($get_sender_details)) {
                                            ...
                                            if ($get_sent_mail_details[0]['sender_type'] == 'vendor') {
                                                $get_sender_details = $this->communication_model->getVendorDetails($get_sent_mail_details[0]['sender_id']);
                                                if (!empty($get_sender_details)) {
                                            ...
                                            if ($get_sent_mail_details[0]['sender_type'] == 'employee') {
                                                $get_sender_details = $this->communication_model->getEmployeeDetails($get_sent_mail_details[0]['sender_id']);
                                                if (!empty($get_sender_details)) {
...
//                                        print_r($check_reply_mails);
                                                ...
                                                <td>
                                                    ...
                                                    <div class="">
                                                        <span class="img" style="min-width: 30px; display: inline-block;">
                                                            ...
                                                            if ($file != '') {
                                                                ?>
                                                                <img src="<?php echo $path . $file; ?>" class="" alt="User Image" width="24px" height="24px">
                                                                <?php
                                                            } else {
                        ...
                        if (!empty($check_reply_mails)) {
                            foreach ($check_reply_mails as $reply_val) {
                                if ($reply_val['sender_id'] == $vendor_id || $reply_val['recipient_id'] == $vendor_id) {
