...
//                                                    $get_vendor_dtls = $this->employee_model->selectVendorList();
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[required,custom[onlyLetterSp]]" type="text" id="project_name" name="project_name" placeholder="Project Name" value="">
                                                    </td>
                                                    <td>
