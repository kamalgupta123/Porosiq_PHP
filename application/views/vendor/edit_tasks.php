                                ...
                                <div class="row">
                                    ...
                                    <div style="margin-top:20px;" class="col-xs-12 col-sm-12 col-md-12">
                                                    ...
                                                    <select name="project_name" class="form-control validate[required]">
                                                        ...
                                                        if(!empty($get_projects)){
                                                            foreach($get_projects as $pval){
                                                                ?>
                                                                <option value="<?php echo $pval['id']; ?>" <?php if($pval['id'] == $get_tasks_data[0]['project_id']){ ?> selected <?php } ?>><?php echo $pval['project_name']; ?></option>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6 col-md-8">
                                                <div class="input-group">
                                                    <textarea name="tasks_description" class="form-control validate[required]"><?php echo $get_tasks_data[0]['tasks_description']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="panel-footer">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <input type="hidden" name="tasks_id" value="<?php echo $get_tasks_data[0]['tasks_id'] ?>">
                                        <input class="btn btn-success" type="submit" name="submit" value="Update Tasks">
                                    </div>
                                </div>
                            </div>
                        </form>
