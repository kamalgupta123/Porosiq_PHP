                                        ...
                                        <table class="table table-bordered table-striped" width="100%" border="1" cellspacing="2" cellpadding="2">
                                            <thead>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td>
                                                            <?php if (!empty($employee->clock_in)) {   
                                                            ?>
                                                            <span class="label label-success">Active</span>
                                                            <?php if ($get_all_employees_break_status[$i]->employee_id == $employee->employee_id)  { ?>
                                                        ...
                                                        <td><a href="<?php echo site_url('add-employee-shift-test/Mjg=?employee_id='.$employee->employee_id); ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
                                                    </tr>
                                                <?php 
                                                    $i++;
                                                    } 
