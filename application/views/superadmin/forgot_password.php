				...
				<div class="hero">
					<section class="content">
						...
						<div class="loginBox">
                            ...
                            <?php } ?>
							<form action="<?php echo site_url('valid_forgot_password'); ?>" class="loginBox__formContainer" method="post" enctype="multipart/form-data">
								...
								<div class="loginBox__login">
									<a class="loginBox__back" href="<?php echo site_url(); ?>">Go Back</a>
									<input
										type="submit"
