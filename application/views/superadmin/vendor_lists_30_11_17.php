...
//                                            $this->load->model('superadmin/manage_vendor_model', 'vendor_model');
                                            ...
                                            $employee_details = $this->vendor_model->getEmployeesDetails($vval['vendor_id']);
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#employee_<?php echo $vval['vendor_id']; ?>"
                                                       data-toggle="modal" title="View Employees" style="color: #09274B;"><i class="fa fa-eye" aria-hidden="true"></i> View Employees</a>
                                                </td>
                                                <td>
                                                    <?php
...
//                                                    }
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <a class="tbl_icon" href="#<?php echo $vval['vendor_id']; ?>"
                                                       data-toggle="modal" title="View Vendor Profile">
                                                    ...
                                                    <!-- Vendor Details -->
                                                    <div class="modal fade" id="<?php echo $vval['vendor_id']; ?>"
                                                         role="dialog">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="box box-primary">
                                                                        <div class="box-body box-profile">
                                                                            ...
                                                                            <h3 class="profile-username text-center"><?php echo $vval['name_prefix'] . " " . $vval['first_name'] . " " . $vval['last_name']; ?></h3>
                                                                                    ...
                                                                                    <table id="vendor_tbl" class="table table-bordered table-striped table-responsive" style="font-size: 11px;">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td><?php echo ($vval['company_id'] != '0') ? $vval['company_id'] : ""; ?></td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <?php
                                                                                                    if (!empty($city_arr)) {
                                                                                                        echo $city_arr[0]['name'];
                                                                                                    }
                                                                                                    ?>
                                                                                                </td>
                                                                                                <td><label>Address</label></td>
                                                                                                <td><?php echo stripslashes($vval['address']); ?></td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td><label>Phone No.</label></td>
                                                                                                <td><?php echo ($vval['phone_no'] != '0') ? $vval['phone_no'] : ''; ?></td>
                                                                                                <td><label>Fax No.</label></td>
                                                                                                <td><?php echo ($vval['fax_no'] != '0') ? $vval['fax_no'] : ''; ?></td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                                                </div>
...
//                        return false;
                        ...
                        } else if (data == 'OOPS !! Vendor has consultant under him.')
                        {
