    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Vendor Documentation</li>
            </ol>
        </section>
                    ...
                    <div class="panel panel-info">
                        <div class="panel-heading">
							...
							if(!empty($get_document_details)){
								...
								$doc_name = $get_document_details[0]['document_name'];
								//echo $doc_name;
							}
                            ?>
                            <h3 class="panel-title">
                                <span class="glyphicon glyphicon-th"></span>
                                Upload Documents for <?php echo $vendor_name_prefix . "" . ucwords($vendor_name) . " [ " . strtoupper($vendor_company_name) . " ] "; ?>
                            </h3>
                        </div>
                        ...
                        <form id="upload_document"
                              action="<?php echo site_url('sadmin_upload_vendor_document'); ?>"
