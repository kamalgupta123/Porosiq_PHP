                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="add_admin_form"
                              action="<?php echo site_url('insert-admin'); ?>"
                                        ...
                                        <table class="table table-bordered table-striped" width="100%" border="1" cellspacing="2" cellpadding="2">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control" type="text" id="admin_employee_id" name="admin_employee_id" placeholder="Employee ID" value="" autocomplete="new-employee-id">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[required]" type="password" id="password" name="password" placeholder="New Password" autocomplete="new-password">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[required,custom[phone],custom[not_start_with_zero],minSize[10],maxSize[10]]" type="text" id="phone" name="phone" placeholder="Phone No." value="">
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="send_credentials">Send Login Credentials</label>
                                                    </td>
                                                    <td>
                                                        <input type="checkbox" name="send_credentials" id="send_credentials" value="yes">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                            ...
                            <div class="panel-footer">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <input class="btn btn-success" type="submit" name="submit" value="Add Admin User">
