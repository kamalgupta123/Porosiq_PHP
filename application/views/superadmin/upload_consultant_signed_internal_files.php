                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="add_documentation_form"
                              action="<?php echo site_url('update_consultant_signed_internal_files'); ?>"
                                        ...
                                        <table class="table table-bordered table-striped" width="100%" border="1"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="25%">
                                                        <label><?php echo $get_internal_file_details[0]['docs_name']; ?></label>
                                                    </td>
                                                    <td width="25%">
                                                    ...
                                                    <td width="25%">
                                                        ...
                                                        <?php
                                                        if ($get_internal_file_details[0]['employee_internal_files'] != '') {
                                                            ?>
                                                            <a href="<?php echo base_url(); ?>uploads/<?php echo $get_internal_file_details[0]['employee_internal_files']; ?>"
