				...
				<div class="hero">
					<section class="content">
						...
						<div class="loginBox">
                            ...
                            <?php } ?>
							<form action="<?php echo site_url('valid_otp'); ?>" method="post" enctype="multipart/form-data" class="loginBox__formContainer">
								...
								<div class="loginBox__login">
									<a class="loginBox__back" href="<?php echo site_url('forgot-password'); ?>">Go Back</a>
									<input
										type="submit"
										value="Submit"
