                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="profile_form"
                              action="<?php echo site_url('sa_update_password'); ?>"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[required]" type="password"
                                                               id="old_password" name="old_password" placeholder="Current Password" autocomplete="off">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[required]" type="password"
                                                               id="password" name="password" placeholder="New Password" autocomplete="off">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[required,equals[password]]" type="password"
                                                               id="conf_password" name="conf_password" placeholder="Confirm New Password" autocomplete="off">
                                                    </td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                </tr>
