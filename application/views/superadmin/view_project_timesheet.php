                        ...
                        <div class="panel panel-default">
                            <div class="panel-body" style="text-align: left;">
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6">
                                    ...
                                    <hr/>
                                    <label>Project Details : </label>&nbsp;<span style="line-height:15px;"><?php echo stripslashes($get_project_details[0]['project_details']); ?></span>
                                    <hr/>
                                    <label>Client Name : </label>&nbsp;<?php echo $get_project_details[0]['client_name']; ?>
                                    <hr/>
                                    <label>Date : </label> &nbsp;<?php echo date("m-d-Y", strtotime($get_project_details[0]['start_date'])) . " - " . date("m-d-Y", strtotime($get_project_details[0]['end_date'])); ?>
                            ...
                            <table class="table table-bordered table-striped" style="font-size: 11px;">
                                <tbody>
                                    <tr style="background-color: #4e4e4e;color: #fff;text-align: center;">
                                        <td style="text-align: center; font-weight: bold;width:80%" colspan="6">Total Working Time</td>
