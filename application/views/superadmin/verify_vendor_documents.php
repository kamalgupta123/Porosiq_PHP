                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <div class="panel panel-info">
                        ...
                        <form id="edit_admin_form"
                              action="<?php echo site_url('sa_verify_documents'); ?>"
                                            ...
                                            <tbody>
                                                ...
                                                if (!empty($get_vendor_documents)) {
                                                    ...
                                                    foreach ($get_vendor_documents as $fval) {
                                                        ...
                                                        $get_sadmin_form = $this->vendor_model->checkAdminForm($fval['id'], $vendor_id);
//echo "<pre>";
//                                                    print_r($get_form_status);
                                                        ...
                                                        <tr>
                                                            <td width="30%">
                                                                <label
                                                                    for="email"><?php echo ucwords($fval['document_name']) ?>
                                                                    :</label>
                                                            </td>
                                                            <td width="11%">
                                                                <?php
                                                                if (!empty($get_form_status)) {
//                                                                echo $get_form_status[0]['sa_form_status'];
                                                                    ?>
                                                                    <select name="file_status[]"
                                                                            class="form-control">
                                                                        <option
                                                                            value="0" <?php if ($get_form_status[0]['sa_form_status'] == '0') { ?> selected="selected" <?php } ?>>
                                                                            Not Approved
                                                                        </option>
                                                                        <option
                                                                            value="1" <?php if ($get_form_status[0]['sa_form_status'] == '1') { ?> selected="selected" <?php } ?>>
                                                                            Approved
                                                                        </option>
                                                                    </select>
                                                            ...
                                                            <td width="11%">
                                                                ...
                                                                if (!empty($get_form_status)) {
                                                                    if ($get_form_status[0]['form_data'] != '') {
                                                                        ?>
                                                                        <span><a
                                                                                href="<?php echo base_url(); ?>sa_view_vendor_document/<?php echo base64_encode($fval['id']); ?>/<?php echo base64_encode($vendor_id); ?>"
                                                            ...
                                                            <td width="11%">
                                                                <?php
                                                                if (isset($get_form_status[0]['sa_form_status']) && $get_form_status[0]['sa_form_status'] != '') {
                                                            ...
                                                            <td width="11%">
                                                                <?php
                                                                if (!empty($get_sadmin_form)) {
                                                                    if ($get_sadmin_form[0]['file'] != '') {
                                                                        ?>
                                                                        <span><a
                                                                                href="<?php echo base_url(); ?>uploads/<?php echo $get_sadmin_form[0]['file']; ?>"
                                                                                class="fancybox" style="color: #09274B;"><i
                                                                                    class="fa fa-download"
                                                            ...
                                                            <td width="11%">
                                                                <a href="<?php echo base_url(); ?>uploads-sadmin-approved-vendor-documents/<?php echo base64_encode($fval['id']); ?>/<?php echo base64_encode($vendor_id); ?>"
                                                                   style="color: #09274B;">
                                                            ...
                                                            <td width="11%">
                                                                <?php
                                                                if (!empty($get_form_status[0]['form_status'] == '1')) {
//                                                                echo $get_form_status[0]['sa_form_status'];
                                                                    ?>
