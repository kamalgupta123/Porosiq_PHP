                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="work_order_form"
                              action="<?php echo site_url('insert_sadmin_ten99user_work_order'); ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <input type="hidden" name="vendor_id"
                                               value="<?php /*echo $get_vendor_details[0]['vendor_id'];*/ echo $vendor_id; ?>">
...
<script>
    ...
    $(function () {
        $("#client_name").on("change", function () {
            ...
            //alert(client_name);
            if (client_name != '') {
                $.post("<?php echo site_url('sadmin_ajax_work_note'); ?>", {client_name: client_name}, function (data) {
                    //alert(data);
                    $('.work-note').html(data);
