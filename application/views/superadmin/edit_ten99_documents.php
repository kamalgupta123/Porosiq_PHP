    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Upload 1099 Users Documents</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="add_documentation_form"
                              action="<?php echo site_url('update_ten99_documentation_form'); ?>"
                                        ...
                                        <table class="table table-bordered table-striped" width="100%" border="1"
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    <label>
                                                        <?php
                                                        echo strtoupper($get_doc_details[0]['document_name']);
                                                        ?>
                                                    </label>
                                                </td>
                                                <td width="25%">
                                                ...
                                                <td width="25%">
                                                    ...
                                                    if ($get_doc_details[0]['file'] != '') {
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>uploads/ten99/documents/<?php echo $get_doc_details[0]['file']; ?>"
