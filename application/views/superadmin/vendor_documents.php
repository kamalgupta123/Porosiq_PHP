                    ...
                    <div class="box">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body" style="text-align: right">
                                <a href="<?php echo base_url('add-vendor-doc'); ?>" style="color: #09274B;"><i
                                        class="fa fa-plus" style="color: green;"></i> Add Vendor Documentation</a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    foreach ($get_documents_details as $aval) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ($aval['file'] != '') {
                                                    ?>
                                                    <a href="<?php echo base_url(); ?>uploads/vendor/documents/<?php echo $aval['file']; ?>"
                                            ...
                                            <td>
                                                <a href="<?php echo base_url(); ?>edit-vendor-documents/<?php echo base64_encode($aval['id']); ?>" style="color: #09274B;"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                        $i++;
