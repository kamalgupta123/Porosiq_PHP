                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="edit_employee_form"
                              action="<?php echo site_url('update-superadmin-employee-user'); ?>"
                                        ...
                                        <table class="table table-bordered table-striped" width="100%" border="1" cellspacing="2" cellpadding="2">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php } if (LATAM) { ?>
                                                    <td>
                                                        <input class="form-control validate[required,custom[phone],minSize[8]]" type="text"
                                                               id="phone_no" name="phone_no" placeholder="Phone No."
                                                               value="<?php echo ($get_employee_data[0]['phone_no'] != '0') ? $get_employee_data[0]['phone_no'] : ''; ?>">
                                                    </td>
                                                    <?php } ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <select name="emp_bill_rate_type" id="emp_bill_rate_type" class="form-control validate[required]">
                                                            ...
                                                            <?php if (LATAM) { ?>
                                                            <option value="monthly" <?php if ($get_employee_data[0]['emp_bill_rate_type'] == 'monthly') { ?> selected <?php } ?>>Monthly</option>
                                                            <?php } ?>
                                                        </select>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <select name="emp_pay_rate_type" id="emp_pay_rate_type" class="form-control validate[required]">
                                                            ...
                                                            <?php if (LATAM) { ?>
                                                            <option value="monthly" <?php if ($get_employee_data[0]['emp_pay_rate_type'] == 'monthly') { ?> selected <?php } ?>>Monthly</option>
                                                            <?php } ?>
                                                        </select>
                                                    </td>
