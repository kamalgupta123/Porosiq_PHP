                                        ...
                                        <table class="table table-bordered table-striped" width="100%" border="1"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[required,minSize[9],maxSize[10]]" type="text" id="federal_tax_id"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[custom[onlyNumberSp],maxSize[3]]" type="text" id="phone_ext" name="phone_ext" placeholder="EXT" value="<?php echo ($get_vendor_data[0]['phone_ext'] != '0') ? $get_vendor_data[0]['phone_ext'] : ''; ?>">
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[required,custom[phone],minSize[10],maxSize[10]]" type="text" id="phone_no" name="phone_no" placeholder="Phone No." value="<?php echo ($get_vendor_data[0]['phone_no'] != '0') ? $get_vendor_data[0]['phone_no'] : ''; ?>">
                                                ...
                                                <tr>
                                                    <td><label for="email">Main Phone Number <span
                                                                style="color: red;">*</span></label></td>
                                                    <td>
                                                        <input class="form-control date validate[required]"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control date validate[required]" type="text"
                                                               ...
                                                               value="<?php echo ($get_vendor_data[0]['contract_from_date'] != '0000-00-00') ? date("m-d-Y", strtotime($get_vendor_data[0]['contract_from_date'])) : ""; ?>">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input class="form-control date validate[required]" type="text" name="contract_to_date"
                                                               id="contract_to_date"
                                                               value="<?php echo ($get_vendor_data[0]['contract_to_date'] != '0000-00-00') ? date("m-d-Y", strtotime($get_vendor_data[0]['contract_to_date'])) : ""; ?>">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
