                        ...
                        <div class="box-body">
                            <div class="col-sm-12 col-md-12">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#home" data-toggle="tab"><span class="glyphicon glyphicon-inbox"></span>Inbox</a></li>
...
//                                                        print_r($mval);
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td width="25%"><a href="<?php echo site_url('inbox_mail_details') . "/" . base64_encode($mval['id']); ?>"><?php echo ucwords($subject); ?></a></td>
                                                            <td width="25%">
                                                                <?php
