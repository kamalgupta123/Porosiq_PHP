                    ...
                    <div class="box">
                        ...
                        <div class="box-body tab-div">
                            <form id="add_employee_form"
                                  action="<?php //echo site_url('search-sa-con-timesheet'); ?>"
                            ...
                            <table class="table table-bordered table-striped" style="font-size: 11px;" id="admin_tbl">
...
<script>
    ...
    $(function () {
        ...
        $('#admin_tbl tfoot th').each(function () {
            var title = $(this).text();
        ...
        $('#admin_tbl').DataTable().columns().every(function () {
            var that = this;
