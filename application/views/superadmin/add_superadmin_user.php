    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add Super Admin User</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="add_admin_form"
                              action="<?php echo site_url('insert_superadmin'); ?>"
                                        ...
                                        <table class="table table-bordered table-striped" width="100%" border="1" cellspacing="2" cellpadding="2">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="25%">
                                                        <input type="checkbox" name="is_asp" id="is_asp" value="1" disabled>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[required,custom[onlyLetterSp]]" type="text" id="name" name="name" placeholder="Full Name" value="">
                                                    </td>
                                                    <td>
                                                        <label for="email">Email ID<span style="color: red;">*</span></label>
                                                    </td>
                                                    <td>
                                                        <input class="form-control validate[required,custom[email]]" type="text" id="email" name="email" placeholder="Email ID" value="" autocomplete="new-email">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[required, custom[not_only_numbers]]" type="password" id="password" name="password" placeholder="New Password" autocomplete="new-password">
                                                    </td>
                                                    <td>
                            ...
                            <div class="panel-footer">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <input class="btn btn-success" type="submit" name="submit" value="Add Super Admin User">
