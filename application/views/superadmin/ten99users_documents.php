        ...
        <section class="content" id="admin_div">
            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12 col-md-12">
                    ...
                    <form id="timesheet_table" action="<?php echo site_url('sa_approve_disapprove_ten99user_documents'); ?>" method="post" enctype="multipart/form-data">
                        <div class="box">
                                    ...
                                    <tbody>
                                        ...
                                        if (count($get_documents_details) > 0) {
                                            ...
                                            foreach ($get_documents_details as $aval) {
                                                $doc_status = "";
                                                $admin_doc_status = "";
                                                $get_consultant_documents = $this->ten99_model->getUploadedDocs($aval['id'], $get_employee_details[0]['employee_id']);
//                                                echo "<pre>";
//                                                print_r($get_consultant_documents);
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>upload_sa_ten99user_documents/<?php echo base64_encode($aval['id']) . '/' . base64_encode($employee_id); ?>" style="color: #09274B;"><i class="fa fa-upload" aria-hidden="true"></i> Upload Document</a>    
                                                    </td>
                                                    <td>
                                                        <?php
                                                        if (!empty($get_consultant_documents)) {
                                                            if ($get_consultant_documents[0]['file'] != '') {
                                                                ...
                                                                <a href="<?php echo base_url(); ?>uploads/<?php echo $get_consultant_documents[0]['file']; ?>"
                                                                   ...
                                                                   ?>
                                                                <a href="<?php echo base_url(); ?>show-files/<?php echo base64_encode($get_consultant_documents[0]['form_no']) . "/" . base64_encode($get_consultant_documents[0]['consultant_id']); ?>" class="fancybox" style="color: #09274B;"><i class="fa fa-eye" aria-hidden="true"></i> View File</a>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
