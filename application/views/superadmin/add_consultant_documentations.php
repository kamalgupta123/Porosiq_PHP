                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="add_documentation_form"
                              action="<?php echo site_url('insert_documentation_form'); ?>"
                                    ...
                                    <div style="margin-top:20px;" class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <table class="table table-bordered table-striped" width="100%" border="1"
                                                    ...
                                                    <td width="25%">
                                                        <span>
                                                            <input class="validate[required]" type="checkbox" id="check1"
                                                                   name="required_for[]" value="C"> Consultants
                                                            <br/>
                                                            <input class="validate[required]" type="checkbox" id="check2"
                                                                   name="required_for[]" value="E"> Employees
                                                        <?php if (LATAM) { ?>
                                                            <br/>
                                                            <input class="validate[required]" type="checkbox" id="check3"
                                                                   name="required_for[]" value="TE"> Temporary Employees
                                                            <br/>
                                                        <?php } ?>
                                                        </span>
                                                    </td>
                                                    <td width="25%">
                                                        <label for="email" class="lbl-css">Document Type (Timewise)</label>
                                                    </td>
                                                    <td width="25%">
                                                        <span>
                                                            <input class="" type="checkbox" id="doc_type" name="doc_type" value="1"> New 
                                                        </span>
                                                    </td>
                                                </tr>
                                                <!-- <tr>
                                                    <td>
                                                       <label class="lbl-css">Document based on Rate Types <span style="color: red;"> *</span></label></label> 
                                                    </td>
                                                    <td> 
                                                        <?php// echo show_rate_type("", true, "checkbox", "rate_type", "rate_type"); ?>
                                                    </td>
                                                    <td>
                                                        <label class="lbl-css">Document based on Employee Classification <span style="color: red;"> *</span></label></label>
                                                    </td>
                                                    <td>
                                            ...
                                            <?php// } ?>
                                                <tr>
                                                    <td>
                                                        <label class="lbl-css">Status <span style="color: red;"> *</span></label></label>
                                                    </td>
                                                    <td>
                                                        <select name="status">
