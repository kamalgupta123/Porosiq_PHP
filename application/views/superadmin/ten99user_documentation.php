    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">1099 Users Documentation</li>
            </ol>
        </section>
                            ...
                            <table id="admin_tbl" class="table table-bordered table-striped" style="font-size: 11px;">
                                ...
                                <tbody>
                                    ...
                                    if ((count($get_documents_details)) > 0) {
										//echo count($get_documents_details);
                                        foreach ($get_documents_details as $aval) {
										//echo "<pre>";
										//print_r($aval);
										//print_r($get_documents_details);
                                            $required_for_arr = array();
                                          //$required_for_arr = explode(",", $aval['required_for']);
                                         //print_r($aval['required_for']);
                                            $get_uploaded_document = $this->ten99_model->getPrevUploaded($aval['id'], $employee_id);
											//print_r($get_uploaded_document);
										   //if (in_array($employee_type, $required_for_arr)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($aval['file'] != '') {
                                                            ?>
                                                            <a href="<?php echo base_url(); ?>uploads/ten99/documents/<?php echo $aval['file']; ?>" class="fancybox" style="color: #09274B;"><i class="fa fa-download" aria-hidden="true"></i> Download Document and Upload With Proper Details</a>
                                                            <?php
                                                        }
                                                        ?>
                                                    </td>
