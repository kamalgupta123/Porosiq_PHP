                ...
                <div class="col-lg-12 col-sm-12 col-md-12">
                    <div class="box">
                        <div class="panel panel-default">
                            <div class="panel-body" style="text-align: right">
                                <a href="<?php echo base_url('add-emp-timesheet'); ?>" style="color: #09274B;"><i class="fa fa-plus" style="color: green;"></i> Add Employee Timesheet</a>
                            </div>
                        </div>
                    </div>
                    <?php if (INDIA) { ?>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body tab-div">
                            ...
                            <!-- <ul class="tabs">
                                <li class="tab-link current" data-tab="tab-1" id="approved_timesheet"><label>Approved Timesheets</label></li>
                                <li class="tab-link" data-tab="tab-2" id="pending_timesheet"><label>Pending Timesheets</label></li>
                                <li class="tab-link" data-tab="tab-3" id="not_approved_timesheet"><label>Not Approved Timesheets</label></li>
                            </ul> -->
                            ...
                            <div id="tab-1" class="tab-content">
                                <table class="table table-bordered table-striped" style="font-size: 12px;" id="a_timesheet_tbl">
                                    ...
                                    // $end_date = "";
                                    // $counter = 0;
                                    // $target_emp_id = !empty($_GET['customid']) ? $_GET['customid'] : 0;
                                    // //$st = "";
                                    // //$ot = "";
                                    
                                    // // if (!empty($target_emp_id)) {
                                    // //     $test = $this->employee_model->getEmployeeData($target_emp_id);
                                    // //     echo "<pre>" . print_r($test, 1) . "</pre>";
                                    // // }

                                    // if (!empty($get_approved_timesheet_details)) {
                                    //     foreach ($get_approved_timesheet_details as $tkey => $tvalue) {

                                    //         if (!empty($target_emp_id) && $tvalue['employee_id'] != $target_emp_id) {
                                    //             continue;
                                    //         }

                                    //         $counter++;
                                    //         if (empty($target_emp_id) && $counter > 250) {
                                    //             break;
                                    //         }
                                    ...
                                    //         $end_date = date("m-d-Y", strtotime($ed));
                                            ?>
                                            <!-- <tr>
                                                <td><a href="<?php //echo base_url() . "sadmin-view-period-timesheet/" . base64_encode($tvalue['id']); ?>"><?php //echo $tvalue['timesheet_id']; ?></a></td>
                            ...
                            <div id="tab-2" class="tab-content">
                                <table class="table table-bordered table-striped" style="font-size: 12px;" id="p_timesheet_tbl">
                                    ...
                                    //     foreach ($get_pending_timesheet_details as $penkey => $penvalue) {
                                    ...
                                    //         $p_end_date = date("m-d-Y", strtotime($p_ed));
                                            ?>
                                            <!-- <tr>
                                                <td><a href="<?php //echo base_url() . "sadmin-view-period-timesheet/" . base64_encode($penvalue['id']); ?>"><?php echo $penvalue['timesheet_id']; ?></a></td>
                                                <td><?php //echo $get_project_data[0]['project_code']; ?></td>
                                                <td><?php //echo $get_project_data[0]['project_name']; ?></td>
                                                <td><?php //echo $get_employee_data[0]['employee_code']; ?></td>
                                                <td><?php //echo $get_employee_data[0]['first_name'] . " " . $get_employee_data[0]['last_name']; ?></td>
                            ...
                            <div id="tab-3" class="tab-content">
                                <table class="table table-bordered table-striped" style="font-size: 12px;" id="n_timesheet_tbl">
                                    ...
                                    //     foreach ($get_not_approved_timesheet_details as $nkey => $nvalue) {
                                    ...
                                    //         $n_end_date = date("m-d-Y", strtotime($n_ed));
                                            ?>
                                            <!-- <tr>
                                                <td><a href="<?php //echo base_url() . "sadmin-view-period-timesheet/" . base64_encode($nvalue['id']); ?>"><?php echo $nvalue['timesheet_id']; ?></a></td>
                                                <td><?php //echo $get_project_data[0]['project_code']; ?></td>
                                                <td><?php //echo $get_project_data[0]['project_name']; ?></td>
                                                <td><?php //echo $get_employee_data[0]['employee_code']; ?></td>
                                                <td><?php //echo $get_employee_data[0]['first_name'] . " " . $get_employee_data[0]['last_name']; ?></td>
...
<script>
    ...
    $(document).ready(function () {
        ...
        // $.ajax({
        //         type: "POST",
        //         url: "<?php echo site_url('sadmin_get_approved_timesheet_data_all'); ?>", 
        //         dataType: "json",  
        //         cache:false,
        ...
        // $(document).on('click', '#pending_timesheet', function() {
        //     $('#overlay').show();
        //     $.ajax({
        //         type: "POST",
        //         url: "<?php echo site_url('sadmin_get_pending_timesheet_data_all'); ?>", 
        //         dataType: "json",  
        //         cache:false,
        //         success: function(data){
        ...
        // $(document).on('click', '#not_approved_timesheet', function(){
        //     $('#overlay').show();
        //     $.ajax({
        //         type: "POST",
        //         url: "<?php echo site_url('sadmin_get_not_approved_timesheet_data_all'); ?>", 
        //         dataType: "json",  
        //         cache:false,
        //         success: function(data){
