    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add Consultant Timesheet</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="add_timesheet_form"
                              action="<?php echo site_url('insert_new_con_timesheet'); ?>"
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <table id="admin_tbl" width="100%" class="table table-bordered table-striped"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td width="8%" align="center"><label>Select Consultant</label>
                                            ...
                                            <td width="10%" align="center">
                                                <select name="employee_id" id="employee_id"
                                                    ...
                                                    <?php
                                                    if (!empty($get_consultant_lists)) {
                                                        foreach ($get_consultant_lists as $cval) {
                                                            ?>
                                                            <option
                                                                value="<?php echo $cval['employee_id']; ?>"><?php echo $cval['employee_code'] . " - " . $cval['first_name'] . " " . $cval['last_name']; ?></option>
                                                            <?php
                                                        }
                                                    }
                                                    ?>
...
<script>
    ...
    function getProjectDetails() {
        ...
        if(employee_id!= '') {
            $.post("<?php echo site_url('ajax_con_project_list'); ?>", {employee_id: employee_id}, function (data) {
                //alert(data);
...
//        alert(project_id);
        ...
        if (project_id != '' && start_date != '' && end_date != '') {
            $.post("<?php echo site_url('ajax_get_con_timesheet_list'); ?>", {
