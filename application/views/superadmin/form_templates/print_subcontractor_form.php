...
<html lang="en">
<head>
    <title>COMPANY SUBCONTRACTOR AGREEMENT</title>
    <meta charset="utf-8">
...
if(!empty($get_form_details)){
  ...
  //echo "<pre>"; print_r($form_data_arr);

    $img_src = $form_data_arr->img_src;
    $con_day = $form_data_arr->con_day;
    $con_month = $form_data_arr->con_month;
    $con_year = $form_data_arr->con_year;
    $con_comp = $form_data_arr->con_comp;
    $con_location = $form_data_arr->con_location;
    $con_tin_no = $form_data_arr->con_tin_no;
    $emp_name = $form_data_arr->emp_name;
    $emp_designation = $form_data_arr->emp_designation;
    $emp_signature = $form_data_arr->emp_signature;
    $emp_witnessth = $form_data_arr->emp_witnessth;
    $vendor_ip = $form_data_arr->vendor_ip;

    $admin_name = $form_data_arr->admin_name;
    $admin_designation = $form_data_arr->admin_designation;
    $admin_signature = $form_data_arr->admin_signature;
}
?>
<div class="container">
    <div class="image">
        ...
        <div class="subcon">
            <p>This SUBCONTRACTOR AGREEMENT made this <span class="sub-css"><?= $con_day ?></span> day of <span
                    class="sub-css"><?= $con_month ?></span>,20<span class="sub-css" style="text-align: left !important; width: 5%;"><?= $con_year ?></span> between PNC
                CAPITAL LLC dba
                PROCURETECHSTAFF CONSULTING SERVICES, with offices located at 155 N Michigan Ave, Suite 513, Chicago IL
                60601 hereinafter referred to as the “Company,” and <span class="sub-css"><?= $con_comp ?></span>
                herein after referred to as the “Consulting Firm,” where applicable, with offices  located at <span
                    class="sub-css"><?= $con_location ?></span>. The Consulting Firm’s Tax
                Identification Number
                is <span class="sub-css"><?= $con_tin_no ?></span>.<br><br>
                RECITALS<br><br>
        ...
        <div class="subcon">
            ...
            <p>
                ...
                including
                verification of salary. (i) Any request for verification of employment, project assignment status or
                other
            ...
            <div class="row space">
                ...
                <div class="col-sm-6 sub-css"><?= $admin_name ?></div>
            </div>
            <div class="row space">
                <div class="col-sm-6">
                    <label class="control-label" for="email"> Designation: </label>
                </div>
                <div class="col-sm-6 sub-css"><?= $admin_designation ?></div>
            </div>
            <div class="row space">
                <div class="col-sm-6">
                    <label class="control-label" for="email"> Signature: </label>
                </div>
                <div class="col-sm-6 sub-css" style="font-family: 'Dancing Script', cursive; font-size: 1.7em;"><?= $admin_signature ?>
                </div>
            </div>
            <div class="row space">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6 sub-css"><?= $emp_witnessth ?>
                </div>
            </div>
            <div class="row space">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6 sub-css"><?= $emp_name ?></div>
            </div>
            <div class="row space">
                <div class="col-sm-6">
                    <label class="control-label" for="email"> Designation: </label>
                </div>
                <div class="col-sm-6 sub-css"><?= $emp_designation ?></div>
            </div>
            <div class="row space">
                <div class="col-sm-6">
                    <label class="control-label" for="email"> Signature: </label>
                </div>
                <div class="col-sm-6 sub-css" style="font-family: 'Dancing Script', cursive; font-size: 1.7em;"><?= $emp_signature ?>
                </div>
            </div>
        </div>
        <div class="image">
