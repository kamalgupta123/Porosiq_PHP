    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Edit Employee Master Shift Data</li>
            </ol>
        </section>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="edit_employee_shift_data_form"
                              action="<?php echo site_url('superadmin-edit-emp-master-shift-data'); ?>"
                                    ...
                                    <div style="margin-top:20px;" class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <table class="table table-bordered table-striped" width="100%" border="1" cellspacing="2" cellpadding="2">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <label for="employee_shift_type">Employee Shift Type / Name</label>
                                                    </td>
                                                    <td>
                                                        <input type="text" id="employee_shift_type" name="employee_shift_type" class="validate[custom[onlyLetterNumber]]" value="<?php echo $employee_shift_type; ?>">
                                                    </td>
                                                    ...
                                                    <td width="25%">
                                                        <select class="select2" id="days" name="days[]" multiple="multiple">
                                                            <option value="MO" <?php if (in_array("MO", $days)) {echo "selected";} ?>>Monday</option>
                                                            <option value="TU" <?php if (in_array("TU", $days)) {echo "selected";} ?>>Tuesday</option>
                                                            <option value="WE" <?php if (in_array("WE", $days)) {echo "selected";} ?>>Wednesday</option>
                                                            <option value="TH" <?php if (in_array("TH", $days)) {echo "selected";} ?>>Thursday</option>
                                                            <option value="FR" <?php if (in_array("FR", $days)) {echo "selected";} ?>>Friday</option>
                                                            <option value="SA" <?php if (in_array("SA", $days)) {echo "selected";} ?>>Saturday</option>
                                                        </select>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                            <input type="time" id="daily_shift_start_time" name="daily_shift_start_time" class="validate[required]" value="<?php echo $daily_shift_start_time; ?>">
                                                    ...
                                                    <td>
                                                        <input type="time" id="daily_shift_end_time" name="daily_shift_end_time" class="validate[required]" value="<?php echo $daily_shift_end_time; ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                <tr>    
                                                    ...
                                                    <td>
                                                        <input type="number" id="paid_break_hours" name="paid_break_hours" class="validate[required]" min="0" value="<?php echo $paid_break_hours; ?>">
                                                    ...
                                                    <td>
                                                        <input type="number" id="unpaid_break_hours" name="unpaid_break_hours" class="validate[required]" min="0" value="<?php echo $unpaid_break_hours; ?>">
                                                        <label for="paid_break_hours" class="lbl-css">(in min.)</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <textarea name="comment" id="comment" cols="50" rows="3"><?php echo $comment; ?></textarea>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
