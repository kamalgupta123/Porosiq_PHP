                                    ...
                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                                        <tr>
                                            <td align="left" valign="top" style="font-family: Palatino Linotype, Book Antiqua, Palatino, serif; font-size: 16px; font-weight: 400; line-height: 24px;">
                                                <p style="font-weight: 800;">  Hi <?php echo $name_prefix . " " . ucwords($admin_name); ?>,</p>
                                                <p style="font-weight: 300;">Your Login Details are as follows. Please Login with below details: </p>
                                                <p><strong>Email ID : </strong><?php echo $admin_email; ?></p>
                                                <p><strong>Temporary Password : </strong><?php echo $admin_password; ?></p>
                                            </td>
                                        </tr>
                                        <tr>
