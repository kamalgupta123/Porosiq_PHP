...
<head>
    ...
    <title>New Admin Registration Successfully</title>
    <style type="text/css">
        body {
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td height="35" align='center'><img
                                                                    src="<?php echo base_url(); ?>assets/images/1.png">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="contentEditable">
                                                                                    <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#1A54BA;'>
                                                                                        <span
                                                                                            class="font"><?php echo PROJECT_NAME; ?></span>
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                        ...
                                                        <tr>
                                                            <td valign='top' align='center'>
                                                                <div
                                                                    ...
                                                                    <div class="contentEditable">
                                                                        <img
                                                                            src="<?php echo base_url(); ?>assets/images/line.png"
                                                            ...
                                                            <td align='left'>
                                                                <div
                                                                    ...
                                                                    <div class="contentEditable" align='center'>
                                                                        <h2>Welcome to <?php echo SITE_NAME . " " . PROJECT_NAME; ?> </h2>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align='left'>
                                                                <div
                                                                    ...
                                                                    <div class="contentEditable" align='center'>
                                                                        <p>
                                                                            Hi, <?php echo $vendor_name . " ( ".$company_id." )"; ?>
                                                                            <br/>
                                                                            Your <?php echo SITE_NAME . " " . PROJECT_NAME; ?>  Account Acctivated Successfully. Please download the attachments and upload signed documents in portal.
                                                                            <br/>
                                                                            ...
                                                                            Cheers,
                                                                            <br/>
                                                                            <span style='color:#222222;'><?php echo SITE_NAME . " " . PROJECT_NAME; ?></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="contentEditable"
                                                                                    ...
                                                                                    <p style='text-align:left;color:#CCCCCC;font-size:12px;font-weight:normal;line-height:20px;'>
                                                                                        <span style='font-weight:bold;'><?php echo COMPANY_NAME; ?></span>
                                                                                        <br>
                                                                                        <?php echo OFFICE_ADDRESS; ?>
                                                                                        <br>
                                                                                        Email : <a href="mailto:<?php echo HELPDESK_EMAIL; ?>"> <?php echo HELPDESK_EMAIL; ?></a><br>
                                                                                        Tel: <a href="tel:<?php echo TELEPHONE; ?>"> <?php echo TELEPHONE; ?></a> Fax:
                                                                                        <?php echo FAX; ?>
                                                                                    </p>
                                                                                </div>
                                                                            </div>
