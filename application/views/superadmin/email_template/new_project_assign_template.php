                                    ...
                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                                        <tr>
                                            <td align="left" valign="top" style="font-family: Palatino Linotype, Book Antiqua, Palatino, serif; font-size: 16px; font-weight: 400; line-height: 24px;">
                                                <p style="font-weight: 800;"><?php echo "Superadmin has assigned a new employee for the following project. Project details and Employee details are as follows:" ; ?></p>
                                                ...
                                                <p style="font-weight: 300;width: 55%;float: left;font-size: 12px;">
                                                    ...
                                                    <label style="font-weight: bold;">Employee Name : </label><?php echo $get_employee_details[0]['name_prefix']. " " .ucwords($get_employee_details[0]['employee_name']); ?><br/>
