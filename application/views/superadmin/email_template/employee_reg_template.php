...
<head>
    ...
    <title>New Employee Registration Successfully</title>
    <style type="text/css">
        body {
                                                        ...
                                                        <tr>
                                                            <td align='left'>
                                                                <div
                                                                    ...
                                                                    <div class="contentEditable" align='center'>
                                                                        <p>
                                                                            Hi, <?php echo $name_prefix . " " .$employee_name; ?>
                                                                            <br/>
                                                                            Your login details are as follows :
                                                                            <br/>
                                                                            Email ID : <?php echo $employee_email; ?>
                                                                            <br/>
                                                                            Password : <?php echo $employee_password; ?>
                                                                            <br/>
