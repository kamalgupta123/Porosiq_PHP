    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add 1099 User</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="add_employee_form"
                              action="<?php echo site_url('insert_superadmin_ten99_user'); ?>"
                                    ...
                                    <div style="margin-top:20px;" class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <table class="table table-bordered table-striped" width="100%" border="1" cellspacing="2" cellpadding="2">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label for="email">1099 User First Name<span
                                                    ...
                                                    <td>
                                                        <label for="email" class="lbl-css">1099 User Last Name<span
                                                                style="color: red;">*</span></label>
                                                    </td>
                                                    <td>
                                                        <input class="form-control validate[required,custom[onlyLetterSp]]" type="text"
                                                ...
                                                <tr>
                                                    <td>
                                                        <label for="email" class="lbl-css">1099 User Designation<span style="color: red;">*</span></label>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <label for="email">User Category<span style="color: red;">*</span></label>
                                                    </td>
                                                    <td>
                            ...
                            <div class="panel-footer">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <input type="hidden" name="employee_type" value="1099">
                                        <input class="btn btn-success" type="submit" name="submit" value="Add 1099 User">
