...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Super Admin User <small>Management</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href=""><i class="fa fa-dashboard"></i> Manage Super Admin User</a></li>
                <li class="active">Edit Super Admin User</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="add_admin_form"
                              action="<?php echo site_url('update_superadmin'); ?>"
                                        ...
                                        <table class="table table-bordered table-striped" width="100%" border="1" cellspacing="2" cellpadding="2">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="25%">
                                                        <?php
                                                        if ($get_superadmin_data[0]['file'] != '') {
                                                            $file_path = "uploads/";
                                                            ?>
                                                            <img src="<?php echo site_url() . $file_path . $get_superadmin_data[0]['file']; ?>" class="user-image"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[required,custom[onlyLetterSp]]" type="text" id="name" name="name" placeholder="Full Name" value="<?php echo $get_superadmin_data[0]['sa_name']; ?>">
                                                    </td>
                                                    <td>
                                                        <label for="email">Email ID<span style="color: red;">*</span></label>
                                                    </td>
                                                    <td>
                                                        <input class="form-control validate[required,custom[email]]" type="text" id="email" name="email" placeholder="Email ID" value="<?php echo $get_superadmin_data[0]['sa_email']; ?>">
                                                    </td>
                                                </tr>
                                                <?php if (US || INDIA) { ?>
                                                <tr>
                                                    <td>
                                                        <label for="is_asp">Authorized Signatory Personnel</label>
                                                    </td>
                                                    <td>
                                                        <input type="checkbox" name="is_asp" id="is_asp" value="1"
                                                        <?php if ($get_superadmin_data[0]['is_asp']) { ?>
                                                            checked
                                                        <?php }?>
                                                        >
                                                    </td>
                            ...
                            <div class="panel-footer">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <input class="btn btn-success" type="submit" name="submit" value="Update Super Admin User">
                                        <a href="javascript:void(0)" onclick="window.history.back();" class="btn btn-default">Back</a>
                                        <input type="hidden" name="sa_id" value="<?php echo $get_superadmin_data[0]['sa_id']; ?>">
                                    </div>
                                </div>
                            </div>
                        </form>
