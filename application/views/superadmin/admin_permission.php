    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Admin Menu Permission</li>
            </ol>
        </section>
                                ...
                                <tbody>
                                    ...
                                    if (count($get_admin_details) > 0) {
                                        ...
                                        foreach ($get_admin_details as $aval) {
                                            $check_permission = $this->menu_model->checkPermission($aval['admin_id']);
                                            ?>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td>
                                                ...
                                                <td><?php echo $aval['name_prefix'] . " " . $aval['first_name'] . " " . $aval['last_name']; ?></td>
                                                ...
                                                <td>
                                                    <a class="tbl_icon"
                                                       href="<?php echo base_url('edit-admin-menu-permission/' . base64_encode($aval['admin_id'])); ?>"
