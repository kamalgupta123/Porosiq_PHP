                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="add_documentation_form"
                              action="<?php echo site_url('insert_consultant_internal_files'); ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div style="margin-top:20px;" class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <table class="table table-bordered table-striped" width="100%" border="1"
                                            ...
                                            <tr>
                                                <td width="25%">
                                                    <label for="email" class="lbl-css">Select Consultant/Employees <span
                                                    ...
                                                    <select name="employee_id" id="employee_id" class="form-control validate[required]">
                                                        ...
                                                        if(!empty($get_employee)){
                                                            foreach($get_employee as $eval){
                                                                ?>
                                                                <option value="<?php echo $eval['employee_id']; ?>"><?php echo $eval['first_name']." ".$eval['last_name']; ?></option>
                                                        <?php
                                                            }
                                                        }
                                                        ?>
