    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Upload Vendor Documents</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="add_documentation_form"
                              action="<?php echo site_url('update_consultant_documentation_form'); ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div style="margin-top:20px;" class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <table class="table table-bordered table-striped" width="100%" border="1"
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%">
                                                    <input class="form-control validate[required]" type="text"
                                                           ...
                                                           placeholder="Document Name" value="<?php echo strtoupper($get_doc_details[0]['document_name']); ?>">
                                                ...
                                                <td width="25%">
                                                    ...
                                                    <?php
                                                    if ($get_doc_details[0]['file'] != '') {
                                                        ?>
                                                        <a href="<?php echo base_url(); ?>uploads/<?php echo $get_doc_details[0]['file']; ?>"
                                            ...
                                            <tr>
                                                <td width="25%">
                                                    <label for="email" class="lbl-css">Required For <span
                                                            style="color: red;">*</span></label>
                                                </td>
                                                <td width="25%">
                                                    <?php
                                                    $required_for_arr = array();
                                                    $required_for_arr = explode(",",$get_doc_details[0]['required_for']);

                                                    ?>
                                                        <span>
                                                        <input class="validate[required]" type="checkbox" id="check1"
                                                               name="required_for[]" value="C" <?php if(!empty($required_for_arr) && in_array("C",$required_for_arr)){ ?> checked <?php } ?>> Consultants
                                                        <br/>
                                                        <input class="validate[required]" type="checkbox" id="check2"
                                                               name="required_for[]" value="E" <?php if(!empty($required_for_arr) && in_array("E",$required_for_arr)){ ?> checked <?php } ?>> Employees
                                                        <?php if (LATAM) { ?>
                                                            <br/>
                                                            <input class="validate[required]" type="checkbox" id="check3"
                                                            name="required_for[]" value="TE" <?php if(!empty($required_for_arr) && in_array("TE",$required_for_arr)){ ?> checked <?php } ?>> Temporary Employees
                                                        <?php } ?>
                                                        </span>
                                                </td>
                                                <td width="25%">&nbsp;</td>
                            ...
                            <div class="panel-footer">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <input type="hidden" name="doc_id" id="doc_id" value="<?php echo base64_encode($get_doc_details[0]['id']); ?>">
                                    </div>
                                </div>
                            </div>
                        </form>
