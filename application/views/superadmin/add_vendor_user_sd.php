                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="add_admin_form"
                              action="<?php echo site_url('insert_vendor_sd'); ?>"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[required,custom[email]]"
                                                               ...
                                                               placeholder="Email ID" value="" autocomplete="new-email-id">
                                                    </td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[required]" type="password"
                                                               id="password" name="password" placeholder="New Password" autocomplete="new-password">
                                                    </td>
                                                    <td>
