				...
				<div class="hero">
					<section class="content">
						...
						<div class="loginBox">
                            ...
                            <?php } ?>
							<form action="<?php echo site_url('sa_reset_password'); ?>" method="post" enctype="multipart/form-data" class="loginBox__formContainer">
								...
								<div class="loginBox__login">
									<a class="loginBox__back" href="<?php echo site_url('otp-forgot-password'); ?>">Go Back</a>
								    <?php
