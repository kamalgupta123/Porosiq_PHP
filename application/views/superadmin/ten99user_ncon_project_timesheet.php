                        ...
                        <div class="panel panel-default">
                            <div class="panel-body" style="text-align: left;">
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6">
                                    ...
                                    <?php }else if($get_employee_details[0]['employee_type'] == '1099'){ ?>
                                    <label>1099 User Code : </label>
                                    <?php } ?>
									...
									<?php }else if($get_employee_details[0]['employee_type'] == '1099'){ ?>
                                    <label>1099 User Designation : </label>
                                    <?php } ?>
                                ...
                                <table class="table table-bordered table-striped" style="font-size: 12px;"
                                    ...
                                    if (!empty($get_timesheet_details)) {
                                        foreach ($get_timesheet_details as $tkey => $tvalue) {
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="<?php echo base_url() . "ten99user-con-view-period-timesheet/" . base64_encode($tvalue['id']); ?>"
                                ...
                                <table class="table table-bordered table-striped" style="font-size: 12px;"
                                    ...
                                    if (!empty($get_timesheet_details_pending)) {
                                        foreach ($get_timesheet_details_pending as $pkey => $pvalue) {
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="<?php echo base_url() . "ten99user-con-view-period-timesheet/" . base64_encode($pvalue['id']); ?>"
                                ...
                                <table class="table table-bordered table-striped" style="font-size: 12px;"
                                    ...
                                    if (!empty($get_timesheet_details_nt_approved)) {
                                        foreach ($get_timesheet_details_nt_approved as $nkey => $nvalue) {
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="<?php echo base_url() . "ten99user-con-view-period-timesheet/" . base64_encode($nvalue['id']); ?>"
