									...
									<div class="panel panel-info">
										<div class="panel-heading">
											<h3 class="panel-title">
												<span class="glyphicon glyphicon-file"></span> Add Document Template
                                        ...
                                        <form id="add_doc_template_form"
											action="<?php echo site_url('insert-document-template'); ?>"
															...
															<tbody>
																<tr>
																	...
																	<td width="25%">
																		...
																		placeholder="Document Template Name" value="">
																	</td>
																	<td colspan="2"></td>
																</tr>
																<tr>
																	...
																	<td><span> 
																		<input class="validate[required]" type="checkbox"
																			id="check1" name="required_for[]" value="C">
																			Consultants &nbsp;&nbsp;&nbsp; 
																		<input class="validate[required]" type="checkbox"
																			id="check1" name="required_for[]" value="E">
																			Employees <br /> 
																		<input class="validate[required]"
																			type="checkbox" id="check2" name="required_for[]"
																			value="TE"> Temporary Employees  &nbsp;&nbsp;&nbsp;
																		<input class="validate[required]"
																			type="checkbox" id="check2" name="required_for[]"
																			value="1099"> 1099 Users
																	</span></td>
...
<script>
    $(document).ready(function () {
        ...
        $("#add_doc_template_form").validationEngine({promptPosition: 'inline'});
    });
</script>
<script>
    $(function () {
