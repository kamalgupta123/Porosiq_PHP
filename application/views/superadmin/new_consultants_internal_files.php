                        ...
                        <div class="box-body">
                            <table id="admin_tbl" class="table table-bordered table-striped" style="font-size: 11px;"
                                ...
                                <tbody>
                                    <?php
                                    $i = 1;
                                    if (count($get_emp_internal_file_details) > 0) {

                                        foreach ($get_emp_internal_file_details as $aval) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="tbl_icon"
                                                       href="<?php echo base_url('all_internal_files/' . base64_encode($aval['employee_id'])); ?>"
                                                       data-toggle="tooltip" title="View "><i
                                                            class="fa fa-eye" aria-hidden="true"
                                                            style="color: #09274B;"></i>
                                                    </a>
                                                    <?php echo $aval['tot_emp']; ?>
                                                </td>
                                            </tr>
                                            <?php
                                            $i++;
