    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add Employee Timesheet</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="add_timesheet_form"
                              action="<?php echo site_url('insert_new_emp_timesheet'); ?>"
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <table id="admin_tbl" width="100%" class="table table-bordered table-striped"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td width="8%" align="center"><label>Select Employee</label>
...
<script>
    ...
    function getProjectDetails() {
        ...
        if(employee_id!= '') {
            $.post("<?php echo site_url('ajax_emp_project_list'); ?>", {employee_id: employee_id}, function (data) {
                //alert(data);
...
<script>
    ...
    $(function () {
        ...
        <?php if (LATAM) { ?>
        $('#add_timesheet_form').on('submit', function() {
            if ($("#start_date").val()=='' || $("#start_date").val()==null || $("#start_date").val()==undefined || $("#end_date").val()=='' || $("#end_date").val()==null || $("#end_date").val()==undefined) {
                alert("Date is not present");
                return false;
            }
            if ($("[data-time-format]").val()=='' || $("[data-time-format]").val()==null || $("[data-time-format]").val()==undefined || $("[data-time-format]").val()=='' || $("[data-time-format]").val()==null || $("[data-time-format]").val()==undefined) {
                alert("Time is empty");
                return false;
            }
        });
...
//        alert(project_id);
        ...
        if (project_id != '' && start_date != '' && end_date != '') {
            $.post("<?php echo site_url('ajax_get_emp_timesheet_list'); ?>", {
