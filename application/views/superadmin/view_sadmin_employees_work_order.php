...
<html lang="en">
    ...
    <body>
        <?php
        $get_vendor_details = $this->employee_model->getVendorDtls($get_work_order[0]['vendor_id']);
        ...
        <div class="container">
            ...
            <table width="100%"
                   style="border:none; text-align:center; overflow:hidden;border-collapse: collapse; border-spacing: 0;">
                <tr class="mar">
                    <td style="border: none;width: 25%;">Procuretechstaff</td>
                    <td style="border: none;width: 25%;">&nbsp;</td>
                    <td style="border: none;width: 25%;">&nbsp;</td>
                    <td style="border-color: currentcolor currentcolor #000;border-image: none;border-style: none none solid;border-width: medium medium 1px;width: 25%;">
                        &nbsp;</td>
                </tr>
                <tr class="mar">
            ...
            <div>
                <form id="add_employee_form"
                      action="<?php echo site_url('update_admin_employee_work_order_status'); ?>"
                    ...
                    <span><label>Status:</label>
                        <select name="approved_by_superadmin" id="approved_by_superadmin" class="form-control" style="width: 25%;">
                            <option value="0" <?php if ($get_work_order[0]['approved_by_superadmin'] == '0') { ?> selected <?php } ?>>Not Approve</option>
                            <option value="1" <?php if ($get_work_order[0]['approved_by_superadmin'] == '1') { ?> selected <?php } ?>>Approve</option>
                        </select>
                    </span>
                    <br/>
                    <input type="hidden" name="work_order_id" value="<?php echo $get_work_order[0]['id']; ?>">
                    <input class="btn btn-success" type="submit" name="submit" value="Update" onclick="return closeFancyBox();">
                </form>
            </div>
