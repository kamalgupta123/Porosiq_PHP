                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="edit_admin_form"
                              action="<?php echo site_url('update_admin_vendor'); ?>"
                                        ...
                                        <table class="table table-bordered table-striped" width="100%" border="1" cellspacing="2" cellpadding="2">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if (LATAM) { ?>
                                                    <td>
                                                        <label for="email">Vendor Tier<span style="color: red;">*</span></label>
                                                    </td>
                                                    <td>
                                                        <select id="vendor_tier" name="vendor_tier">
                                                            <?php
                                                                echo show_vendor_tier($get_vendor_data[0]['vendor_tier'], true);
                                                            ?>
                                                        </select>
                                                    </td>
                                                    <?php } ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[required,custom[onlyLetterSp]]" type="text" id="vendor_designation" name="vendor_designation" placeholder="Designation" value="<?php echo $get_vendor_data[0]['vendor_designation']; ?>">
                                                    </td>
                                                    <td>
                                                        <label for="email">Company <span style="color: red;">*</span></label>
                                                    </td>
                                                    <td>
                                                        <input class="form-control validate[required]" type="text" id="vendor_company_name" name="vendor_company_name" placeholder="Company" value="<?php echo $get_vendor_data[0]['vendor_company_name']; ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[required,minSize[9],maxSize[10]]" type="text" id="Federal Tax ID"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[custom[onlyNumberSp],maxSize[3]]" type="text" id="phone_ext" name="phone_ext" placeholder="Phone EXT." value="<?php echo ($get_vendor_data[0]['phone_ext'] != '0') ? $get_vendor_data[0]['phone_ext'] : ''; ?>">
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea name="remittance_address" id="remittance_address" class="form-control validate[required]" rows="5" cols="10" placeholder="Remittance Address" style="resize: none;"><?php echo stripslashes($get_vendor_data[0]['remittance_address']); ?></textarea>
                                                    </td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control date validate[required]" type="text" name="main_contact_person" id="main_contact_person" value="<?php echo $get_vendor_data[0]['main_contact_person']; ?>">
                                                    </td>
                                                    <td>
                                                        <label for="email">Main Email Address <span style="color: red;">*</span></label>
                                                    </td>
                                                    <td>
                                                        <input class="form-control date validate[required,custom[email]]" type="text" name="main_email_address" id="main_email_address" value="<?php echo $get_vendor_data[0]['main_email_address']; ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><label for="email">Main Phone Number <span style="color: red;">*</span></label></td>
                                                    <td>
                                                        <input class="form-control date validate[required]" type="text" name="main_phone_no" id="main_phone_no" value="<?php echo $get_vendor_data[0]['main_phone_no']; ?>">
                                                    </td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control date validate[required]" type="text" name="billing_contact_person" id="billing_contact_person" value="<?php echo $get_vendor_data[0]['billing_contact_person']; ?>">
                                                    </td>
                                                    <td>
                                                        <label for="email">Billing Email Address <span style="color: red;">*</span></label>
                                                    </td>
                                                    <td>
                                                        <input class="form-control date validate[required,custom[email]]" type="text" name="billing_email_address" id="billing_email_address" value="<?php echo $get_vendor_data[0]['billing_email_address']; ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><label for="email">Billing Phone Number <span style="color: red;">*</span></label></td>
                                                    <td>
                                                        <input class="form-control date validate[required]" type="text" name="billing_phone_no" id="billing_phone_no"value="<?php echo $get_vendor_data[0]['billing_phone_no']; ?>">
                                                    </td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control date validate[required]" type="text" name="additional_contact_person" id="additional_contact_person" value="<?php echo $get_vendor_data[0]['additional_contact_person']; ?>">
                                                    </td>
                                                    <td>
                                                        <label for="email">Additional Email Address <span style="color: red;">*</span></label>
                                                    </td>
                                                    <td>
                                                        <input class="form-control date validate[required,custom[email]]" type="text" name="additional_email_address" id="additional_email_address" value="<?php echo $get_vendor_data[0]['additional_email_address']; ?>">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><label for="email">Additional Phone Number <span style="color: red;">*</span></label></td>
                                                    <td>
                                                        <input class="form-control date validate[required]" type="text" name="additional_phone_no" id="additional_phone_no" value="<?php echo $get_vendor_data[0]['additional_phone_no']; ?>">
                                                    </td>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name="nglcc" id="nglcc" class="validate[required]">                                                            <option
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control date validate[required]" type="text" name="contract_from_date"
                                                               id="contract_from_date" value="<?php echo ($get_vendor_data[0]['contract_from_date'] != '0000-00-00') ? date("m-d-Y", strtotime($get_vendor_data[0]['contract_from_date'])) : ""; ?>">
                                                    </td>
                                                    <td>
                                                        <label for="email">Contract To Date <span style="color: red;">*</span></label>
                                                    </td>
                                                    <td>
                                                        <input class="form-control date validate[required]" type="text" name="contract_to_date"
                                                               id="contract_to_date" value="<?php echo ($get_vendor_data[0]['contract_to_date'] != '0000-00-00') ? date("m-d-Y", strtotime($get_vendor_data[0]['contract_to_date'])) : ""; ?>">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                            ...
                            <div class="panel-footer">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <input type="hidden" name="vendor_id" value="<?php echo base64_encode($get_vendor_data[0]['vendor_id']); ?>">
...
<script>
    ...
    function getstatedetails(id) {
        var country_id = id;
        $.post("<?php echo site_url('ajax_admin_state_list'); ?>", {country_id: country_id}, function (data) {
            //alert(data);
            $('#state').html(data);
    ...
    function getcitydetails(id) {
        var state_id = id;
        $.post("<?php echo site_url('ajax_admin_city_list'); ?>", {state_id: state_id}, function (data) {
            //alert(data);
            $('#city').html(data);
