                                ...
                                <div style="margin-top:20px;" class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <table class="table table-bordered table-striped" width="100%" border="1"
                                        ...
                                        <tr>
                                            ...
                                            <?php if (LATAM) { ?>
                                            <td>
                                                <label for="email">Vendor Tier</label>
                                            </td>
                                            <td>
                                                <?php

                                                    if(isset($get_vendor_data[0]['vendor_tier']) && $get_vendor_data[0]['vendor_tier'] != "0") {

                                                        echo show_vendor_tier($get_vendor_data[0]['vendor_tier'], false);
                                                    }
                                                ?>
                                            </td>
                                            <?php } ?>
