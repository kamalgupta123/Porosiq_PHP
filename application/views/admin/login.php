...
<html lang="en">
	<head>
		...
		<link
			...
			rel="stylesheet"
		/>
		<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/login_client.css" />
		<link
			rel="stylesheet"
			...
			<script type="text/javascript">
				$(document).ready(function() {
					...
					function client_dataRecieved(result) {
						...
						if (userID != undefined) {
							window.location.href = '<?php echo base_url(); ?>qr_code/'+userID; //site_url use here
						}
					}
				...
				<div class="content">
					...
					<div class="content__inputBox">
						<div class="loginBox">
                            ...
                            <?php } ?>
                            <?PHP if (defined ("USE_SSO_OKTA") && USE_SSO_OKTA) { ?>
                            <form action="<?php echo site_url('admin_okta_login'); ?>" method="post" enctype="multipart/form-data" class="loginBox__formContainer">
								<div class="loginBox__loginAs form-group">
									...
									>
										<?php echo get_login_user_types('admin', true); ?>
									</select>
								</div>
								<input
									type="submit"
							...
							<?php } else { ?>
							<form action="<?php echo site_url('admin_valid_login'); ?>" method="post" enctype="multipart/form-data" class="loginBox__formContainer">
								<div class="loginBox__loginAs form-group">
									<label for="user">Login as</label>
									<select
										style="padding-left: 8px;"
								...
								<div class="loginBox__login">
									...
									<a class="loginBox__forgot" href="<?php echo base_url('admin-forgot-password'); ?>">Forgot Password?</a>
								</div>
								<input
									type="submit"
									value="Sign In"
