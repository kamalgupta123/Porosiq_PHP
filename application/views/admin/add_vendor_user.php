                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <form id="add_vendor_form"
                              action="<?php echo site_url('insert_admin_vendor'); ?>"
                                        ...
                                        <table class="table table-bordered table-striped" width="100%" border="1"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="25%">
                                                        <input class="validate[required] image-file" type="file"
                                                               name="photo">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[required,minSize[9],maxSize[10]]" type="text"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control validate[custom[onlyNumberSp],maxSize[3]]" type="text" id="phone_ext" name="phone_ext" placeholder="EXT." value="">
                                                    </td>
                                                    <td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <input type="hidden" name="admin_id"
                                               value="<?php echo $get_details[0]['admin_id']; ?>">
...
<script>
    $(document).ready(function () {
        ...
        $("#add_vendor_form").validationEngine({promptPosition: 'inline'});
    });
