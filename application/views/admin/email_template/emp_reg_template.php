                                    ...
                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                                        <tr>
                                            <td align="left" valign="top" style="font-family: Palatino Linotype, Book Antiqua, Palatino, serif; font-size: 16px; font-weight: 400; line-height: 24px;">
                                                <p style="font-weight: 800;">  <?php echo ucwords($name_prefix) . " " . ucwords($admin_name) . " has added new employee successfully. Employee Details are as follows : "; ?></p>
                                                <p style="font-weight: 300;">
                                                    <label><strong>Employee Details : </strong></label><br/>
                                                    <label><strong>Employee Code : </strong> <?php echo strtoupper($employee_code); ?></label><br/>
                                                    <label><strong>Employee Name : </strong> <?php echo $name_prefix . " " . ucwords($employee_name); ?></label><br/>
                                                    <label><strong>Employee Designation : </strong> <?php echo $employee_designation . " " . ucwords($employee_name); ?></label><br/>
                                                    <label><strong>Employee Category : </strong> <?php echo ($employee_category == '1') ? "W2" : "Subcontractor"; ?></label><br/>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
