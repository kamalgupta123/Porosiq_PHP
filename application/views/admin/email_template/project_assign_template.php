...
<html>
    <head>
        <title>New Vendor Registration Successfuly</title>
                                    ...
                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;">
                                        <tr>
                                            <td align="left" valign="top" style="font-family: Palatino Linotype, Book Antiqua, Palatino, serif; font-size: 16px; font-weight: 400; line-height: 24px;">
                                                <p style="font-weight: 800;">  Hi <?php echo ucwords($vendor_name); ?>,</p>
                                                <p style="font-weight: 300;">New project <?php echo ucwords($project_name); ?> is assigned to you. Requirements details of the project are as follows :  </p>
                                                <p><strong>Req Code : </strong><?php echo strtoupper($project_code); ?></p>
                                                <p><strong>Project Type : </strong><?php echo ucwords($project_type); ?></p>
                                                <p><strong>Project Name : </strong><?php echo ucwords($project_name); ?></p>
                                                <p><strong>Project Details : </strong><?php echo stripslashes($project_details); ?></p>
                                                <p><strong>Client Name : </strong><?php echo ucwords($client_name); ?></p>
                                                <p><strong>Start Date : </strong><?php echo date("m-d-Y", strtotime($start_date)); ?></p>
                                                <p><strong>End Date : </strong><?php if($end_date != '0000-00-00'){ echo date("d-m-Y", strtotime($end_date)); } else{ echo ""; } ?></p>
                                            </td>
                                        </tr>
