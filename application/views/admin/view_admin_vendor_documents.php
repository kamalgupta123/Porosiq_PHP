                ...
                <div class="col-lg-12 col-sm-12 col-md-12">
                    <div class="box">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body" style="text-align: left; padding: 0px 0px 0px 10px;">
                                <?php
                                ...
                                ?>
                                <h3 class="box-title">Vendor Document Lists for <?php echo $vendor_name_prefix . " " . ucwords($vendor_name); ?></h3>
                            </div>
                        </div>
                    </div>
                    <form id="timesheet_table" action="<?php echo site_url('admin_approve_disapprove_vendor_documents'); ?>" method="post" enctype="multipart/form-data">
                        <div class="box">
...
//                                                print_r($get_uploaded_vendor_documents);
                                                ...
                                                <tr>
                                                    ...
                                                    if (!empty($get_uploaded_vendor_documents)) {
                                                        $doc_status = $get_uploaded_vendor_documents[0]['form_status'];
                                                        $sa_doc_status = $get_uploaded_vendor_documents[0]['sa_form_status'];
                                                        ?>
                                                        <td>
														...
														//print_r("in IF ".$get_uploaded_vendor_documents[0]['file']);
                                                            if ($get_uploaded_vendor_documents[0]['file'] != '') {
                                                                ...
                                                                <a href="<?php echo base_url(); ?>uploads/vendor_pdfs/<?php echo $get_uploaded_vendor_documents[0]['file']; ?>"
                                                                   ...
                                                                   ?>
                                                                <a href="<?php echo base_url(); ?>admin_view_vendor_submitted_document/<?php 
