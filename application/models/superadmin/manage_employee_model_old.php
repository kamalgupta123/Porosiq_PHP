...
//        echo $this->db->last_query();
    ...
    public function insert_shift_break_form_data($employee_id, $clock_time_id, $break_type, $start_date, $start_time, $end_date, $end_time, $is_paid, $comment, $created_by, $created_time) {
        ...
        $query_str = "INSERT INTO `demossql`.`vms_employee_break_time` (`employee_id`,`clock_time_id`,`break_type`,`break_start_time`,`break_end_time`,`is_paid`, `comment`, `created_by`,`created_time`) VALUES ($employee_id, $clock_time_id, '$break_type','$start_time','$end_time',$is_paid,'$comment', $created_by, '$created_time')";
    ...
    public function get_employee_clock_data_main($employee_id, $date) {
        ...
        $query_str = "SELECT *,vec.id as clock_id FROM demossql.vms_employee_clock_time vec WHERE vec.employee_id=$employee_id AND DATE(vec.clock_in)='$date'";
    ...
    public function get_employee_clock_data($employee_id, $date)
    {
        ...
        $query_str = "SELECT *,veb.id as break_id,vec.id as clock_id FROM demossql.vms_employee_clock_time vec LEFT JOIN demossql.vms_employee_break_time veb ON vec.id = veb.clock_time_id WHERE vec.employee_id=$employee_id AND DATE(vec.clock_in)='$date'";
    ...
    public function update_clock_admin_data($clock_in_date, $clock_in_time, $clock_out_date, $clock_out_time, $comment, $clock_id) {
        ...
        $query_str = "UPDATE `demossql`.`vms_employee_clock_time` SET `clock_in` = '$clock_in_date',`clock_out` = '$clock_out_date', `comment` = '$comment', `modified_by` = ".$this->session->userdata('clock_break_data_admin_id').", `modified_time` = '".date('Y-m-d H:i:s')."' WHERE `id` = $clock_id";
    ...
    public function update_training_break_admin($training_break_start_date, $training_break_start_time, $training_break_end_date, $training_break_end_time, $comment,$training_break_id) {
        ...
        $query_str = "UPDATE `demossql`.`vms_employee_break_time` SET `break_start_time` = '$training_break_start_date',`break_end_time` = '$training_break_end_date', `comment` = '$comment', `modified_by` = ".$this->session->userdata('clock_break_data_admin_id').", `modified_time` = '".date('Y-m-d H:i:s')."' WHERE `id` = $training_break_id";
    ...
    public function update_personal_break_admin($personal_break_start_date, $personal_break_start_time, $personal_break_end_date, $personal_break_end_time, $comment, $personal_break_id) {
        ...
        $query_str = "UPDATE `demossql`.`vms_employee_break_time` SET `break_start_time` = '$personal_break_start_date',`break_end_time` = '$personal_break_end_date',`comment` = '$comment',`modified_by` = ".$this->session->userdata('clock_break_data_admin_id').", `modified_time` = '".date('Y-m-d H:i:s')."' WHERE `id` = $personal_break_id";
    ...
    public function update_meeting_break_admin($meeting_break_start_date, $meeting_break_start_time,$meeting_break_end_date, $meeting_break_end_time, $comment, $meeting_break_id) {
        ...
        $query_str = "UPDATE `demossql`.`vms_employee_break_time` SET `break_start_time` = '$meeting_break_start_date',`break_end_time` = '$meeting_break_end_date',`comment` = '$comment', `modified_by` = ".$this->session->userdata('clock_break_data_admin_id').", `modified_time` = '".date('Y-m-d H:i:s')."' WHERE `id` = $meeting_break_id";
    ...
    public function update_lunch_break_admin($lunch_break_start_date, $lunch_break_start_time,$lunch_break_end_date, $lunch_break_end_time, $comment, $lunch_break_id) {
        ...
        $query_str = "UPDATE `demossql`.`vms_employee_break_time` SET `break_start_time` = '$lunch_break_start_date',`break_end_time` = '$lunch_break_end_date',`comment` = '$comment', `modified_by` = ".$this->session->userdata('clock_break_data_admin_id').", `modified_time` = '".date('Y-m-d H:i:s')."' WHERE `id` = $lunch_break_id";
    ...
    public function get_employee_group_list() {
        $query_str = "SELECT COUNT(e.group_id) as employee, g.group_id, g.group_name, g.group_description FROM porosiq.group g LEFT JOIN porosiq.vms_employee_master e ON g.group_id = e.group_id GROUP BY g.group_id";
