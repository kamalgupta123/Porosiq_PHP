...
(function(e) {
    ...
    e.widget("selectBox.selectBoxIt", {
        ...
        _createDropdownButton: function() {
            var t = this,
                ...
                i = t.selectBox.attr("class") || "";
            return t.dropdownText = e("<span/>", {
                id: n && n + "SelectBoxItText",
                "class": "selectboxit-text",
                unselectable: "on",
                text: t.firstSelectItem.text()
            }).attr("data-val", t.originalElem.value), t.dropdownImageContainer = e("<span/>", {
                ...
                "class": "selectboxit-container " + (r === "container" ? i : "")
            }).append(t.dropdown), t
        },
        ...
        _replaceSelectBox: function() {
            var t = this,
                n, r = t.originalElem.id || "";
            return t.selectBox.css("display", "none").after(t.dropdownContainer), n = t.dropdown.height(), t.downArrow = e("<i/>", {
                ...
                unselectable: "on"
            }).append(t.downArrow), t.dropdown.append(t.downArrowContainer), t.listItems.removeClass("selectboxit-selected").eq(t.currentFocus).addClass("selectboxit-selected"), t.dropdownImageContainer.width() || t.dropdownImageContainer.remove(), t.options.autoWidth && t.dropdown.css({
                width: "auto"
            }).css({
                width: t.list.outerWidth(!0) + t.downArrowContainer.outerWidth(!0) + t.dropdownImage.outerWidth(!0)
            }), t.dropdownText.css({
                "max-width": t.dropdownContainer.width() - (t.downArrowContainer.outerWidth(!0) + t.dropdownImage.outerWidth(!0))
            }), t
        },
        ...
        _update: function(e) {
            var t = this,
                n, r, i = t.options.defaultText || t.selectBox.attr("data-text");
        ...
        _addClasses: function(t) {
            var n = this,
                ...
                a = t.container,
                f = t.open;
            return n.focusClass = r, n.openClass = f, n.selectedClass = "selectboxit-selected", n.downArrow.addClass(n.selectBox.data("downarrow") || n.options.downArrowIcon || u), n.dropdownContainer.addClass(a), n.dropdown.addClass(s), n.list.addClass(o), n.listItems.bind({
                "focusin.selectBoxIt": function() {
                    e(this).addClass(r)
                },
                "blur.selectBoxIt": function() {
                ...
                "open.selectBoxIt": function() {
                    var e = n.list.find("li[data-val='" + n.dropdownText.attr("data-val") + "']"),
                        t;
        ...
        triggerEvent: function(e) {
            ...
            return t.selectBox.trigger(e, {
                elem: t.selectBox.eq(n),
                "dropdown-elem": t.listItems.eq(t.currentFocus)
            }), t
        },
    ...
    i._ariaAccessibility = function() {
        var t = this;
        return t.dropdown.attr({
            role: "combobox",
            "aria-autocomplete": "list",
            "aria-expanded": "false",
            "aria-owns": t.list.attr("id"),
            "aria-activedescendant": t.listItems.eq(t.currentFocus).attr("id"),
            "aria-label": e("label[for='" + t.originalElem.id + "']").text() || "",
            "aria-live": "assertive"
        }).bind({
            "disable.selectBoxIt": function() {
        ...
        var e = this,
            t, n, r;
        e.dropdownContainer.append(e.selectBox), e.selectBox.css({
            display: "block",
            width: e.dropdown.outerWidth(),
